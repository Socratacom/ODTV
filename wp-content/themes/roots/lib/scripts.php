...
function roots_scripts() {
  ...
  if (WP_ENV === 'development') {
    $assets = array(
      ...
      'shuffle'   => '/assets/js/plugins/jquery.shuffle.min.js'
    );
  } else {
  ...
  wp_enqueue_style('open_sans', '//fonts.googleapis.com/css?family=Open+Sans:400,300,600');
  ...
  wp_enqueue_script('shuffle', get_template_directory_uri() . $assets['shuffle'], array(), null, true);
